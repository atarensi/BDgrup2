...
CREATE TABLE municipis (
	...
	CONSTRAINT uk_municipis_codi_ine UNIQUE (codi_ine, provincia_id,districte) *
);
...
CREATE TABLE eleccions_municipis (
    ...
    CONSTRAINT pk_eleccions_municipis PRIMARY KEY (eleccio_id,municipi_id,num_meses,cens),
...
DROP TABLE vots_candidatures_prov;
DROP TABLE vots_candidatures_mun;
DROP TABLE vots_candidatures_ca;
DROP TABLE candidats;
DROP TABLE persones;
DROP TABLE eleccions_municipis;
DROP TABLE candidatures;
DROP TABLE municipis;
DROP TABLE provincies;
DROP TABLE eleccions;
DROP TABLE comunitats_autonomes;
